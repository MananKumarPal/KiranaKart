...
def insert():
    ...
    if(qty!=''):
        if (int(qty)>0 and int(qty)<int(sqty[0])):
            ...
            db.commit()
            messagebox.showinfo("Digital Dukaan ","Succesful!")
        elif(int(qty)>int(sqty[0])):
            messagebox.showinfo("Digital Dukaan ","Sorry. We have inadequate stocks")
        else:
            messagebox.showinfo("Digital Dukaan ","Please set the quantity to atleast 1")
    else:
        messagebox.showinfo("Digital Dukaan ","Quantity is a mandatory field and cannot be left empty")
...
def update():
    ...
    db.commit()
    messagebox.showinfo("Digital Dukaan","Updation of records will be highlited when you again visit this section")
...
def delete():
    ...
    db.commit()
    messagebox.showinfo("Digital Dukaan","deletion of records will be highlited when you again visit this section")
...
def back():
    ...
    Label(root,text="©2022 Manan & Bhaskar ",font="arial 7 ").place(x=60,y=113)
...
def exitt():
    ...
    if (name=="" or name==" "):
        messagebox.showinfo("Digital Dukaan","Mandatory (*) Fields cannot be empty")
    else:
...
def Goback():
    ...
    try:
        ...
        Label(root1,text="©2022 Manan & Bhaskar ",font="arial 7 ").place(x=60,y=113)
...
def insertscr():
    ...
    Label(root2,text="©2022 Manan & Bhaskar ",font="arial 7 ").place(x=60,y=113)
    ...
    Label(root3,text="©2022 Manan & Bhaskar ",font="arial 7 ").place(x=60,y=113)
...
def deletescr():
    ...
    if (reco==[]):
        messagebox.showinfo("Digital Dukaan","Cart empty! Cannot proceed.")
    else:    
        root1.destroy()
...
company (Digital Dukaan here) distributes the default passwords and username to the amdins and it can never be changed..
...
def aupdate():
    ...
    cur.execute(sql1,val)
    db.commit()
    messagebox.showinfo("Digital Dukaan","Stocks updated successfully")
...
def login():
    ...
    if i in rec:
        ...
        messagebox.showinfo("Digital Dukaan","Invalid Credentials! Please try again")
